...
<img src="/BST.png?raw=true" alt="Binary Search Tree" width="400" height="500">
...
![Alt text](/segmentTree.png?raw=true "Segment Tree")
...
<img src="/heap.png?raw=true" alt="Max Heap" width="400" height="500">
...
![Alt text](/hash.png?raw=true "Hashing")
...
![Alt text](/quicksort.gif?raw=true "Quicksort")
...
![Alt text](/mergesort.gif?raw=true "Mergesort")
...
![Alt text](/bucketsort.png?raw=true "Bucket Sort")
...
![Alt text](/dfsbfs.gif?raw=true "DFS / BFS Traversal")
...
![Alt text](/dijkstra.gif?raw=true "Dijkstra's")
...
![Alt text](/bellman-ford.gif?raw=true "Bellman-Ford")
...
![Alt text](/prim.gif?raw=true "Prim's Algorithm")
...
![Alt text](/kruskal.gif?raw=true "Kruskal's Algorithm")
...
![Alt text](/bigO.png?raw=true "Theta Notation")
...
![Alt text](/bigOmega.png?raw=true "Theta Notation")
...
![Alt text](/theta.png?raw=true "Theta Notation")
